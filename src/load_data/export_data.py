...
def get_processed_data_path() -> str:
    ...
    module_dir = Path(os.path.dirname(__file__))
    str_path = str(module_dir / "data" / "processed_data.jsonl")
...
def get_processed_dataset() -> Dataset:
    ...
    # Load full dataset
    full_dataset = load_dataset("json", data_files=str(get_processed_data_path()))['train']
    
    # Split into train and test
    splits = full_dataset.train_test_split(
        test_size=100,  # Exact number of test examples
